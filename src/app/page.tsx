          ...
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1.5">
              ...
              <BlurFade delay={BLUR_FADE_DELAY * 2}>
                <Link href="/CV - Thomas Tartrau.pdf" target="_blank">
          ...
          {DATA.work.map((work, id) => (
            ...
            >
              <ResumeCard
                ...
                href={work.href}
                badges={work.badges}
                period={`${work.start} - ${work.end ?? "Présent"}`}
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Découvrez mes dernières actualités dans le monde de la technologie.
              </p>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                et je vous répondrai dès que possible. Je ne répondrai pas aux sollicitations commerciales.
              </p>
            </div>
          </BlurFade>
        </div>
